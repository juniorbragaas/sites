...
//CONFIGURAR LABELS
$config->setHeader(array("Codigo","Data","Categoria","Descricao","Empresa","Observacao","Prazo","Status","Cadastrado por"));
...
$config->setInitWidths(array("100","160","160","100","120","160","120","160","120","160","160"));
...
$config->attachHeader("#numeric_filter,#text_filter,#combo_filter,#text_filter,#text_filter,#text_filter,#text_filter,#combo_filter,#text_filter",null);
...
$conn->render_complex_sql($SQL,"numero_chamado","numero_chamado,data,categoria,descricao,empresa,observacao,prazo,status,cadastrado_por");     // data configuration
?>
