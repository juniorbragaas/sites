...
?>
	...
	<tr style=" <?= $display_historico; ?> "> <td><label>Status atual da nota<br></label><B>PENDENTE</b></td><td><input type="button" class="cancelamento"  value="Cancelar esse chamado" /></td></tr>
	<tr><td colspan="8"><div id="MostraHistorico" style=" <?= $display_historico; ?> "><label>Histórico do chamados</label><br><div id="gridbox_historico" style="width:100%; height:200px;"></div><script>MontaGrid2();</script></div></td></tr>
	</table>
