...
<html>
<head>
	<title>TOFFY T-CHAMADOS : Sistemas de controle de chamados</title>
...
<div>
		...
		<iframe name="painel" id="painel" src="<?= $srcframe ?>" style="min-height:1000px; width:100%; overflow-y: scrool;"></iframe>
		</div>
