...
//CONFIGURAR LABELS
$config->setHeader(array("Codigo","Integrante","Login","Perfil","Ativo","Acessado em"));
...
$SQL = "
		SELECT 
			m1.codigo as codigo,
			if(m2.nome_completo IS NULL,'indefinido',m2.nome_completo) as atendente,
			m1.login as login,
			p.nome as perfil,
		...
		FROM 
			tc_users m1
			LEFT JOIN tc_atendentes m2 On m1.profissional = m2.codigo
