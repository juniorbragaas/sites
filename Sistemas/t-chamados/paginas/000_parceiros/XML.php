...
//CONFIGURAR LABELS
$config->setHeader(array("Codigo","Tipo","Nome","Cidade","Estado","Telefone","Email"));
...
FROM 
tc_parceiros a";
$conn->render_complex_sql($SQL,"codigo","codigo,tipo,nome,cidade,uf,telefone,email");     // data configuration
?>
