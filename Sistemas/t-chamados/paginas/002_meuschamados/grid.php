...
<br><br><br><br>
	...
	<input class="alterar"  type="button" style="height:30px; " value="Histórico" onclick="if(myGrid.getSelectedRowId()) { location.href='CRUD.php?acao=historico&codigo='+ myGrid.getSelectedRowId(); } else { alert('Selecione um registro para alterar!');}" />
