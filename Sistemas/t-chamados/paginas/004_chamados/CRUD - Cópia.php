...
?>
	...
	<tr>
		...
		<td><label>COD Responsável<br></label><?=$codigo?></td>
		<td colspan="2" style="<?= $display_encaminhar ?>"><label><?=$encaminhado?><br></label>
...
?>
	...
	<tr>
		<td colspan="4">Observação atual</td>
	</tr>
	<tr>
		<td colspan="4"><textarea id="<?=$nome_id?>" name="<?=$nome_id?>" rows="8" cols="100" <?= $readonlyobs ?>><?= $observacao_atual?>
</textarea></td>
	...
	<tr style="<?=$display_historico ?>">
		<td colspan="4"><textarea id="observacao" name="observacao" rows="8" cols="100" >
</textarea></td>
