...
//CONFIGURAR LABELS
$config->setHeader(array("Codigo","Data","Categoria","Descricao","Empresa","Responsavel","Observacao","Prazo","Status","Cadastrado por"));
//CONFIGURAR TIPOS DE COLUNA
$config->setColTypes(array("ro","ro","ro","ro","ro","ro","ro","ro","ro","ro"));
//CONFIGURAR ALINHAMENTO DE COLUNA
$config->setColAlign(array("left","left","center","left","left","left","left","left","left","left"));
//CONFIGURAR LARGURA DE COLUNA
$config->setInitWidths(array("100","160","160","100","120","160","120","160","120","120","160","160"));
//CONFIGURAR TIPOS DE FILTRO DE COLUNAS
$config->setColSorting(array("int","str","str","int","str","str","str","str","str","str","str"));
//DELIMITADOR DE CONFIGURAÇÃO DE CABEÇALHO
$config->setHeaderDelimiter(",");
//ADICIONANDO FILTRO DE PESQUISA
$config->attachHeader("#numeric_filter,#text_filter,#combo_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#combo_filter,#text_filter",null);
...
$conn->render_complex_sql($SQL,"numero_chamado","numero_chamado,data,categoria,descricao,empresa,nome,observacao,prazo,status,cadastrado_por");     // data configuration
?>
