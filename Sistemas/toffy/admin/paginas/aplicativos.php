...
<div style="background-color:#2C8DB5; color:#FFF; ">
	<center><h4 style="font-size:30px;">Aplicativos </h4></center>
</div>
...
$(document).ready(function () {/* activate scroll spy menu */
	...
	function Cadastrar() {
        ...
        return eModal
            .iframe('<?= $caminho_servidor ?>/admin/paginas/CRUD/CRUD_aplicativos.php?acao=cadastro', title)
    }
	function Alterar() {
        ...
        return eModal
            .iframe('<?= $caminho_servidor ?>/admin/paginas/CRUD/CRUD_aplicativos.php?acao=alterar&id='+ document.getElementById("hdnId").value, title)
        }
		else
		{
	...
	function Excluir() {
        ...
        return eModal
            .iframe('<?= $caminho_servidor ?>/admin/paginas/CRUD/CRUD_aplicativos.php?acao=excluir&id='+ document.getElementById("hdnId").value, title)
		}
		else
		{
