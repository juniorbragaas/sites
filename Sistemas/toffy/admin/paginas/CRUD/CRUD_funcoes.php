...
if(!empty($_POST)) 
	{ 
			...
			if(strcmp($_POST['CRUD_query'],"insert")==0)
			{
						...
						$SQL = "INSERT INTO gl_funcoes (nome,fk_departamento) 
			...
			if(strcmp($_POST['CRUD_query'],"delete")==0)
			{
						...
						$codigo = $_POST['codigo'];					
						$SQL = "DELETE FROM gl_funcoes WHERE codigo = '$codigo';";								
						$query = mysql_query($SQL);
						$erro_banco = mysql_errno($con)." : ".mysql_error($con);
						if(strcmp($erro_banco,"0 : ")==0)
						{
			...
			if(!empty($_GET['id'])) 
			{
			  ...
			  {				
				if(strcmp($_GET['acao'],"alterar")==0)
			   {
				...
				c.codigo as codigo,
				c.nome as nome,
				c.fk_departamento as departamento
				FROM gl_funcoes c WHERE c.codigo = '$id'
...
<div class="form-group col-md-4">
<div class="clearfix">
<label for="exampleInputEmail1">Departamento</label><br>
