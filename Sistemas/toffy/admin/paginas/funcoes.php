...
<div style="background-color:#2C8DB5; color:#FFF; ">
	<center><h4 style="font-size:30px;">Funções </h4></center>
</div>
<div class="container">	
    <!-- Botões da tela -->	
  <div  id="carregandoslide" style="background-image: url('<?= $caminho_servidor ?>/imagens/aguarde.gif'); background-size: 100% 300px;
    background-repeat: no-repeat; height: 300px; text-align:right; vertical-align: text-top; " ></div>
	<div id="painelSlider"">
	...
	<div class="row">
			...
			<div class="col-md-14">
				...
				<div class="col-md-14" id="lista_clientes">
					...
					c.codigo as codigo,
					c.nome as nome,
					c2.nome as departamento
					FROM gl_funcoes c
					LEFT JOIN gl_departamentos c2 ON c2.codigo = c.fk_departamento
...
$(document).ready(function () {/* activate scroll spy menu */
	...
	function Cadastrar() {
        ...
        return eModal
            .iframe('<?= $caminho_servidor ?>/admin/paginas/CRUD/CRUD_funcoes.php?acao=cadastro', title)
	...
	function Alterar() {
        ...
        return eModal
            .iframe('<?= $caminho_servidor ?>/admin/paginas/CRUD/CRUD_funcoes.php?acao=alterar&id='+ document.getElementById("hdnId").value, title)
        }
		else
		{
	...
	function Excluir() {
        ...
        return eModal
            .iframe('<?= $caminho_servidor ?>/admin/paginas/CRUD/CRUD_funcoes.php?acao=excluir&id='+ document.getElementById("hdnId").value, title)
		}
		else
		{
