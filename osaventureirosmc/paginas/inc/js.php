...
<script src="http://www.toffy.com.br/js/eModal.min.js"></script>
...
<script  type="text/javascript" src="../js/montaDataTable.js"></script>
	...
	<!-- fancybox init Rolagem deslizante do menu -->
	<script>
	var $doc = $('html, body');
