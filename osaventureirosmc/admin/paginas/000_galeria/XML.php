...
//CONFIGURAR LABELS
$config->setHeader(array("Codigo","Titulo","Data","Descricao","Modificado_em"));
...
$config->setInitWidths(array("80","160","80","200","120"));
//CONFIGURAR TIPOS DE FILTRO DE COLUNAS
$config->setColSorting(array("int","str","str","str","str"));
//DELIMITADOR DE CONFIGURAÇÃO DE CABEÇALHO
$config->setHeaderDelimiter(",");
//ADICIONANDO FILTRO DE PESQUISA
$config->attachHeader("#numeric_filter,#text_filter,#text_filter,#text_filter,#text_filter",null);
...
a.cadastrado_em as cadastrado_em
FROM 
tc_galeria a
";
$conn->render_complex_sql($SQL,"codigo","codigo,titulo,data,descricao,cadastrado_em");     // data configuration
?>
