...
<head>
  <link rel="stylesheet" type="text/css" href="<?= $caminho_servidor ?>/css/estilo.css"/>
	...
	<tr>
		...
		<td><label>Apelido <br></label><input type="text" id="apelido" name="apelido" placeholder="Digite um nome*" value="<?= $apelido ?>"required <?= $readonly ?> ></td>
		<td><label>CPF<br></label><input type="text" id="cpf" name="cpf" placeholder="Digite um nome*" value="<?= $cpf ?>"required <?= $readonly ?> ></td>
		<td><label>Arquivo foto <br></label><input type="text" id="foto" name="foto" placeholder="Digite um nome*" value="<?= $foto ?>"required <?= $readonly ?> ></td>		
	</tr>	
	<tr>
	...
	<tr>
		...
		<td><label>Sede<br></label>
			...
			<option value="sjdr" <? if(strcmp("sjdr",$sede)== 0) { echo " selected "; } ?>>São João Del Rei - MG</option>
			<option value="jf" <? if(strcmp("jf",$sede)== 0) { echo " selected "; } ?>>Juiz de Fora - MG</option>
			<option value="ro" <? if(strcmp("ro",$sede)== 0) { echo " selected "; } ?>>Rio das Ostras - RJ</option>
			<option value="itauna" <? if(strcmp("itauna",$sede)== 0) { echo " selected "; } ?>>Itaúna - MG</option>
			<option value="pm" <? if(strcmp("pm",$sede)== 0) { echo " selected "; } ?>>Pará de Minas - MG</option>
			<option value="barbacena" <? if(strcmp("barbacena",$sede)== 0) { echo " selected "; } ?>>Barbacena - MG</option>
			<option value="coimbra" <? if(strcmp("coimbra",$sede)== 0) { echo " selected "; } ?>>Coimbra - MG</option>
			</select>
		</td>
	</tr>	
	<tr>
