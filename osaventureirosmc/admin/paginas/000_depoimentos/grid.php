...
<br><br><br><br>
    <div id="tela">
	<div id="cabecalho_pagina" width="100%" style="background-color: #827D7D; color: #FFFFFF;"><center>Cadastro de Depoimentos : Tabela</center></div>
	...
	<td style="background-color: blue; vertical-align: middle;">
     <input class="adicionar" type="button" style="height:30px; " value="Adicionar" onclick="location.href='CRUD.php?acao=cadastrar&codigo=0';" />
	...
	<div id="gridbox" style="width:100%; height:600px;"></div>
