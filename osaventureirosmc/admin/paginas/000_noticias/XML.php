...
//CONFIGURAR LABELS
$config->setHeader(array("Codigo","Título","Descrição","Início","Destaque","Cadastrado em"));
...
$config->setInitWidths(array("80","200","200","100","100","100"));
...
";
$conn->render_complex_sql($SQL,"codigo","codigo,titulo,descricao,data_inicio,destaque,cadastrado_em");     // data configuration
?>
