<? 
	...
	$SQL = " SELECT
				*
				FROM tc_eventos  WHERE codigo = '$codigo' and noticia = 1
...
<br><br><br><br>
	...
	<tr>
		<td colspan="4"><br>Informações da Notícia</td>
	</tr>
	...
	<tr>
		<td colspan="4"><br>Descrição da notícia</td>
	</tr>
	<tr>
<td colspan="4">
