...
$cont2 = 0;
				...
				do 
				{
					...
					$dia = utf8_encode($linha[dia]);
					$mes = utf8_encode($linha[mes]);
					$ano = utf8_encode($linha[ano]);
					if($cont2 != $total)
					{
						echo "{title: '$titulo', description: '$titulo', datetime: new Date($ano,$mes,$dia, 17),url:'www.google.com'},";
					}
					else
					{
					    echo "{title: '$titulo', description: '$titulo', datetime: new Date($ano,$mes,$dia, 17),url:'www.google.com'}";
